...
trait GeneratedTupleConverters extends LowPriorityTupleConverters {
  ...
  implicit def tuple1Converter[A](implicit gA: TupleGetter[A]): TupleConverter[Tuple1[A]] = TupleConverter1(gA)

  case class TupleConverter2[A, B](
    gA: TupleGetter[A],
  ...
  case class TupleConverter3[A, B, C](
    gA: TupleGetter[A],
    gB: TupleGetter[B],
